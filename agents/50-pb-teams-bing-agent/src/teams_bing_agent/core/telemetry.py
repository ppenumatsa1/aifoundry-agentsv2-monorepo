...
def _build_config(settings: Settings) -> TelemetryConfig | None:
    ...
    return TelemetryConfig(
        ...
        service_name=settings.otel_service_name or "pb-teams-bing-agent",
...
def initialize_telemetry(settings: Settings) -> bool:
    ...
    if hasattr(tracer_provider, "add_span_processor"):
        tracer_provider.add_span_processor(AgentDimensionSpanProcessor(settings.foundry_agent_id))
