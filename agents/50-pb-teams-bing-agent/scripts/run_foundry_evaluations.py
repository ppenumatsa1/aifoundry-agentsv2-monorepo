...
from teams_bing_agent.runtime.openai_client import (  # type: ignore[import-not-found]  # noqa: E402
    build_project_client,
)

DEFAULT_DATA_PATH = ROOT_DIR / "src/teams_bing_agent/evals/datasets/golden_capture.jsonl"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--evaluation-name",
        default="pb-teams-bing-agent-eval",
