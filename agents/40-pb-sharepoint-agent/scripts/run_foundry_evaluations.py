...
from sharepoint_agent.evals.batch import build_project_client  # type: ignore[import-not-found]  # noqa: E402

DEFAULT_DATA_PATH = ROOT_DIR / "src/sharepoint_agent/evals/datasets/golden_capture.jsonl"
...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--evaluation-name",
        default="pb-sharepoint-agent-eval",
