...
from sharepoint_agent.core.logging import get_logger  # type: ignore[import-not-found]  # noqa: E402

SCRIPTS_DIR = ROOT_DIR / "scripts"
PYTHON = sys.executable or "python3"

QUESTIONS_PATH = ROOT_DIR / "src/sharepoint_agent/evals/datasets/questions.jsonl"
CAPTURE_PATH = ROOT_DIR / "src/sharepoint_agent/evals/datasets/golden_capture.jsonl"
EVALUATION_NAME = "pb-sharepoint-agent-eval"
SMOKE_QUESTION = "Summarize key security requirements from the connected SharePoint docs."
